...
| **[RefineNovo](https://arxiv.org/pdf/2506.13485)** | [RefineNovo-30M](https://drive.google.com/file/d/1NtEIdrm1lccZRWOeO20-2c3Ekop-BhCJ/view?usp=sharing)                                                                                      | NAT      | An ultra-stable NAT model framework that can adapt to any data distributions. (most stable training so far). |
...
| **[CrossNovo](https://arxiv.org/pdf/2510.08169)**   | [CrossNovo](https://drive.google.com/file/d/1Zfzpu5JHUvMXfvNPA-QVGzXMyF499vFL/view?usp=sharing)      | -        | A framework for combining AT and NAT for Peptide Sequencing.    (Best Performance on 9Species Benchmark among all, slower than naive AT and NAT however)                                   |
...
- **[2025-09]** CrossNovo has been accepted by NeurIPS'2025. 🎉 (Code Coming Soon, going through final cleaning up)

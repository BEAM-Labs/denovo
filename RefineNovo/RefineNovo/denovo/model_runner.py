...
def predict(
    ...
    """
    Predict peptide sequences with a trained RefineNovo model.
...
def evaluate(peak_path: str, model_filename: str, config: Dict[str,
                                                               Any]) -> None:
    """
    Evaluate peptide sequence predictions from a trained RefineNovo model.
...
def _execute_existing(
    ...
    """
    Predict peptide sequences with a trained RefineNovo model with/without
    evaluation.
